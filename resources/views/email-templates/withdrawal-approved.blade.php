                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="col" align="center" width="400" bgcolor="#fff" style="padding: 10px 0 ">
                                                                    ...
                                                                    <img src="{{asset('assets/images/mail/withdrawal-approved.png')}}" alt="" width="500" height="100%">
                                                            ...
                                                            <tr>
                                                                <td class="col px-sm-16" bgcolor="#FFFFFF" align="left"
                                                                    ...
                                                                    <h1 class="quicksand"
                                                                        ...
                                                                        Withdrawal Approve</h1>
                                                                    <p class="source"
                                                                        style="color: #718096;font-size: 16px; font-weight: 300; line-height: 21px ; margin-bottom: 25px;">
                                                                        We're pleased to confirm that your withdrawal request has been successfully processed.
                                                                        </p>

                                                                    <p class="source"
                                                                        style="color: #718096;font-size: 16px; font-weight: 300; line-height: 21px ; margin-bottom: 25px;">
                                                                        The funds have been transferred to your designated account. Please allow a few business days for the transaction to reflect, depending on your bank or payment provider.</p>

                                                                    <p class="source" style="color: #718096;font-size: 16px; font-weight: 300; line-height: 21px ; margin-bottom: 25px;">
                                                                        Should you have any queries or require further assistance, don't hesitate to reach out to our support team.</p>
