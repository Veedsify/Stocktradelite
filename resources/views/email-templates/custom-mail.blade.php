                                                            ...
                                                            <tr>
                                                                <td class="col" align="center" width="400"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        data-name="Layer 1" width="400" height="100%"
                                                                        ...
                                                                        <circle
                                                                            ...
                                                                            data-name="Ellipse 300" cx="77.832" cy="324"
                                                                            r="28" fill="#fa896b" />
                                                                        <circle
                                                                            id="ffdbdf53-78c2-412f-9ede-372406e5d245"
                                                                            data-name="Ellipse 301" cx="207.832"
                                                                            cy="179" r="28" fill="#ccc" />
                                                                        <circle
                                                                            id="b7cff929-f00d-4f86-944c-e500b6ceb6ad"
                                                                            data-name="Ellipse 302" cx="337.832"
                                                                            cy="252" r="28" fill="#e6e6e6" />
                                                                        <circle
                                                                            id="eabc0b76-6faa-4fa0-934c-daff28b491dd"
                                                                            data-name="Ellipse 303" cx="467.832" cy="28"
                                                                            r="28" fill="#fa896b" />
                                                                        <circle
                                                                            id="a7ca0488-8ee6-49e2-b245-2872b84c042e"
                                                                            data-name="Ellipse 304" cx="717.832"
                                                                            cy="236.535" r="28" fill="#fa896b" />
                                                                        <path
                                                                            id="b579ef19-595a-43de-9b6d-0ead8268ca48-366"
                                                                            data-name="Path 1507"
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#9e616a" />
                                                                        <path
                                                                            id="be4b35b3-6955-40b7-9549-45fdba6a2930-369"
                                                                            data-name="Path 1509"
                                                                        ...
                                                                        <circle
                                                                            ...
                                                                            data-name="Ellipse 307" cx="708.75198"
                                                                            cy="314.48401" r="20.75" fill="#9e616a" />
                                                                        <path
                                                                            id="fb091cb1-8ad4-4d57-b74d-c940c723d6bf-370"
                                                                            data-name="Path 1512"
