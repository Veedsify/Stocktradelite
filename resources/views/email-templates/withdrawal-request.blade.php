                                                            ...
                                                            <tr>
                                                                <td class="col" align="center" width="400"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="400"
                                                                        height="100%" viewBox="0 0 851.034 593.12578"
                                                                        ...
                                                                        <g id="i" transform="translate(0 -32.533)">
                                                                            ...
                                                                            <path id="l-187"
                                                                                ...
                                                                                fill="#e6e6e6" />
                                                                            <circle id="m" cx="306.19202" cy="273.55079"
                                                                                r="8.89099" fill="#e6e6e6" />
                                                                        </g>
                                                                        <g id="n" transform="translate(0 0.223)">
                                                                            ...
                                                                            <path id="p-189"
                                                                                ...
                                                                                fill="#e6e6e6" />
                                                                            <circle id="q" cx="306.19202" cy="449.55079"
                                                                                r="8.89099" fill="#e6e6e6" />
                                                                        </g>
                                                                        <g id="r" transform="translate(0 0.223)">
                                                                            ...
                                                                            <path id="t-191"
                                                                                ...
                                                                                fill="#e6e6e6" />
                                                                            <circle id="u" cx="306.19202" cy="361.55079"
                                                                                r="8.89099" fill="#e6e6e6" />
                                                                        </g>
                                                                        <g>
                                                                            <circle cx="712.16968" cy="147.07086"
                                                                                r="25.04932" fill="#ffb6b6" />
                                                                            <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#3f3d56" />
                                                                        <circle id="x" cx="317.60202" cy="163.7928"
                                                                            r="5.556" fill="#fa896b" />
                                                                        <circle id="y" cx="365.56604" cy="164.0388"
                                                                            r="5.556" fill="#fa896b" />
                                                                        <circle id="a`" cx="414.276" cy="145.19179"
                                                                            r="5.556" fill="#fa896b" />
                                                                        <path id="aa-194"
                                                                        ...
                                                                        <rect id="ag" y="590.2298" width="851.034"
                                                                            height="1.68298" fill="#e6e6e6" />
                                                                        <g>
                                                                            <path id="ah-200"
                                                                        ...
                                                                        <polygon
                                                                            ...
                                                                            fill="#2f2e41" />
                                                                        <circle cx="112.2962" cy="175.87539"
                                                                            r="20.28835" fill="#ffb6b6" />
                                                                        <path
