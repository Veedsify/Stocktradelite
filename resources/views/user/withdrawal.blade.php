                        ...
                        <div class="card">
                            <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
                              <li class="nav-item" role="presentation">
                                <button class="nav-link position-relative rounded-0 active d-flex align-items-center justify-content-center bg-transparent fs-3 py-4" id="bitcoin-tab" data-bs-toggle="pill" data-bs-target="#bitcoin" type="button" role="tab" aria-controls="bitcoin" aria-selected="true">
                                  <i class="ti ti-coin-bitcoin me-2 fs-6"></i>
                                  <span class="d-none d-md-block">Bitcoin</span>
                                </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-4" id="ethereum-tab" data-bs-toggle="pill" data-bs-target="#ethereum" type="button" role="tab" aria-controls="ethereum" aria-selected="false">
                              ...
                              <li class="nav-item" role="presentation">
                                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-4" id="bank-transfer-tab" data-bs-toggle="pill" data-bs-target="#bank-transfer" type="button" role="tab" aria-controls="bank-transfer" aria-selected="false">
                                  <i class="ti ti-wallet me-2 fs-6"></i>
                                  <span class="d-none d-md-block">Bank Transfer</span>
                                </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-4" id="credit-card-tab" data-bs-toggle="pill" data-bs-target="#credit-card" type="button" role="tab" aria-controls="credit-card" aria-selected="false">
                            ...
                            {{-- Bitcoin start --}}
                              <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="bitcoin" role="tabpanel" aria-labelledby="bitcoin-tab" tabindex="0">
                                  <div class="row p-0">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                      <div>
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputtext4" placeholder="BTC Address">
                                                      </div>
                                                    </div>
                                                    <div class="col-12">
                                                      <div>
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            ...
                                                            <input type="text" class="form-control" id="exampleInputtext4" placeholder="ETH Address">
                                                          </div>
                                                        </div>
                                                        <div class="col-12">
                                                          <div>
                                ...
                                <div class="tab-pane fade" id="bank-transfer" role="tabpanel" aria-labelledby="bank-transfer-tab" tabindex="0">
                                    <div class="row p-0">
                                        <div class="col-12 p-0 d-flex align-items-stretch">
                                          <div class=" w-100  p-0 position-relative overflow-hidden">
                                            <div class=" m-0 p-2">
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            ...
                                                            <input type="text" class="form-control" id="exampleInputtext4" placeholder="Enter Bank Name">
                                                          </div>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            <label for="exampleInputtext4" class="form-label">Account Name</label>
                                                            <input type="text" class="form-control" id="exampleInputtext4" placeholder="Enter Account Name">
                                                          </div>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            <label for="exampleInputtext4" class="form-label">Account Number</label>
                                                            <input type="number" class="form-control" id="exampleInputtext4" placeholder="Enter Account Number">
                                                          </div>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            <label for="exampleInputtext4" class="form-label">Swift Code</label>
                                                            <input type="number" class="form-control" id="exampleInputtext4" placeholder="Enter Swift Code">
                                                          </div>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                          <div>
                                ...
                                <div class="tab-pane fade" id="credit-card" role="tabpanel" aria-labelledby="credit-card-tab" tabindex="0">
                                    <div class="row p-0">
                                        <div class="col-12 p-0 d-flex align-items-stretch">
                                          <div class=" w-100  p-0 position-relative overflow-hidden">
                                            <div class=" m-0 p-2">
                                              ...
                                              <p class="card-subtitle mb-4">Request for withdrawal using Credit Card</p>
                                                    ...
                                                    <form>
                                                      <div class="row">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            <label for="exampleInputtext4" class="form-label">*FullName (Surname First)</label>
                                                            <input type="text" class="form-control" id="exampleInputtext4" placeholder="(on the card)">
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 mb-3">
                                                          <div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <input type="number" class="form-control" id="exampleInputtext4" placeholder="Enter Card Number">
